        ...
        <div className="relative z-10 max-w-3xl mx-auto px-6 md:px-10 pt-12 pb-16">
          <div className="rounded-3xl border border-warm-300/40 p-6 sm:p-8 md:p-10 bg-white/70 backdrop-blur-md shadow-xl shadow-warm-200/25">
            <div className="prose prose-lg max-w-none text-text-secondary leading-relaxed">
              ...
              <p>
                האתר משמש כפלטפורמה להמלצות בלבד. המוצרים המוצגים באתר אינם נמכרים
                על ידינו ואנו משמשים כמתווכים בין המשתמש לבין הספקים החיצוניים בלבד.
              </p>
              <p>
                <strong>אנו לא נושאים באחריות כלשהי על המוצרים המוצגים באתר</strong>,
                לרבות איכותם, תקינותם, בטיחותם, התאמתם לצרכים מסוימים, או כל עניין
                אחר הנוגע למוצר. כל המלצה באתר מבוססת על דעה אישית וחוויה אישית בלבד
                ואינה מהווה ייעוץ מקצועי מכל סוג.
              </p>
              <p>
                האחריות המלאה לבדיקת המוצר, הספק, תנאי הרכישה, מדיניות ההחזרות,
                והתאמת המוצר לצרכיך חלה על המשתמש בלבד. מומלץ לבדוק את הספק,
                לקרוא ביקורות, ולוודא את תנאי העסקה לפני כל רכישה.
              </p>
              <p>
